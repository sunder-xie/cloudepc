package com.tqmall.data.epc.common.redis.interceptor;

import com.tqmall.data.epc.common.redis.RedisClientTemplate;
import com.tqmall.data.epc.common.redis.annotation.RedisCache;
import com.tqmall.data.epc.common.redis.annotation.RedisKeyParam;
...
public class RedisCacheInterceptor implements MethodInterceptor {
    ...
    private Object parseCache(Method method, String redisStr){
        ...
        return JsonUtil.jsonToObject(redisStr, rType);
    }
