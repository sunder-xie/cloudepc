...
public class VerifyCodeUtil {
    ...
    public static BufferedImage outputImage(int w, int h, String code) {
        ...
        drawWords(w, h, code, verifySize, g2);
        g2.dispose();
        return image;
    }

    private static void drawWords(int w, int h, String code, int verifySize, Graphics2D g2) {
        Random random = new Random();
        char[] chars = code.toCharArray();
        for (int i = 0; i < verifySize; i++) {
            int fontSize = random.nextInt(60) + 30;
    ...
    private static void drawLines(int w, int h, Graphics2D g2) {
        Random random = new Random();
