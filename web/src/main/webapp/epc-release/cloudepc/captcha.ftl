...
<head>
    ...
    <link href="/epc-release/resources/common/count-down/coming-soon.css" rel="stylesheet" type="text/css">
    <link href="/epc-release/resources/captcha/captcha.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <script src="/epc-release/resources/common/other/jquery.min.js" type="text/javascript"></script>
    <script src="/epc-release/resources/common/count-down/jquery.countdown.js" type="text/javascript"></script>
    <script src="/epc-release/resources/common/count-down/jquery.countdown-zh-CN.js" type="text/javascript"></script>
    <#--<script src="/epc-release/resources/captcha/forbidSpider.js" type="text/javascript"></script>-->
    <script src="/epc-release/resources/captcha/captcha.js" type="text/javascript"></script>
