...
<!-- END BODY -->
<!-- build:js ../resources/oe/oe.js -->
<script src="/epc-dev/resources/common/other/jquery.jqpagination.js" type="text/javascript"></script>
<script src="/epc-dev/resources/common/epc/pagination.js" type="text/javascript"></script>
...
<script src="/epc-dev/resources/oe/oe.js" type="text/javascript"></script>
<!-- endbuild -->
</html>
