            ...
            <div class="fl content-msg-div">
                ...
                <div class="content-detail-div">
                    <div class="fl ta-l order-info-div">
                        <p>订单号：<span class="order-sn">${orderInfo.offerListSn}</span></p>
                        <p>订单总金额：<span class="strong">¥ ${orderInfo.offerAmount}</span></p>
                        <p>支付金额：<span class="strong">¥ ${orderInfo.paidOfferAmount}</span></p>
                        <p>页面在 <span class="strong return-time">15秒</span> 后自动返回到 <a href="/wish/myOfferPage">我的报价订单</a></p>
...
<#include "/epc-dev/cloudepc/common/resource/js.ftl"/>
    ...
    <script type="text/javascript">
        ...
        function setRemainTime() {
            if (curCount == 0) {
                window.location.href = '/wish/myOfferPage';
            } else {
                curCount--;
