...
<div class="content w1190">
    ...
    <#include "/epc-dev/cloudepc/template/lopTemplate.ftl"/>
    <#include "/epc-dev/cloudepc/lop/wish/cancelWish.ftl"/>

</body>

<!-- build:js ../resources/lop/showOffer.js -->
...
<script src="/epc-dev/resources/lop/wish/cancelWish.js" type="text/javascript"></script>
<script src="/epc-dev/resources/lop/offer/showOffer.js" type="text/javascript"></script>
<!-- endbuild -->
