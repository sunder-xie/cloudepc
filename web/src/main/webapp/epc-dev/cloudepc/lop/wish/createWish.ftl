...
<head>
    ...
    <!-- 输入联想样式 -->
    <!-- build:css ../resources/lop/createWish.css -->
    <link rel="stylesheet" href="/epc-dev/resources/common/jquery-ui/jquery-ui.min.css">
    <!-- endbuild -->
...
<div class="create-wish-background">
    ...
    <#--<#include "/epc-dev/cloudepc/common/avidCall/avidCallEntry.ftl">-->
...
<!-- END BODY -->
<!-- build:js ../resources/lop/createWish.js -->
<!-- 输入联想js -->
<script src="/epc-dev/resources/common/jquery-ui/jquery-ui.min.js"></script>
<script src="/epc-dev/resources/common/plupload/js/plupload.full.min.js"></script>
<script src="/epc-dev/resources/common/epc/upload/upload.js"></script>
...
<script src="/epc-dev/resources/lop/lop.js" type="text/javascript"></script>
<script src="/epc-dev/resources/lop/wish/createWish.js" type="text/javascript"></script>
<script src="/epc-dev/resources/common/epc/avidCallEntry.js" type="text/javascript"></script>
<!-- endbuild -->
