...
<body>
    ...
    <#include "/epc-dev/cloudepc/template/shoppingCartTemplate.ftl"/>
    <#include "/epc-dev/cloudepc/part/adaptiveCar.ftl"/>

</body>

<!-- build:js ../resources/shopping/shoppingCartInfo.js -->
...
<script src="/epc-dev/resources/shopping/shoppingCartInfo.js" type="text/javascript"></script>
<!-- endbuild -->
</html>
