...
<head>
    ...
    <!-- build:css ../resources/verifyShop/verify.css -->
    <link rel="stylesheet" type="text/css" href="/epc-dev/resources/common/select2/css/select2.min.css"/>
    <link rel="stylesheet" type="text/css" href="/epc-dev/resources/verify/verify.css"/>
    <!-- endbuild -->
    ...
    <div class="content form-wizard">
        ...
        <#--手机号码-->
            <div class="tab-pane <#if nowStep == 1 >active</#if>" id="phone_tab">
                <#include "/epc-dev/cloudepc/verifyShop/verifyIndex_phone.ftl">
                <div class="btn-group">
        ...
        <#--填写资料-->
            <#if nowStep gt 1 >
                <div class="tab-pane <#if nowStep == 2 >active</#if>" id="data_tab">
                    <#include "/epc-dev/cloudepc/verifyShop/verifyIndex_data.ftl">
                    <div class="btn-group">
                        <div class="col-sm-offset-3 col-md-offset-4 col-sm-9 col-md-8 text_left">
            ...
            <#--上传照片-->
                <div class="tab-pane <#if nowStep == 3 >active</#if>" id="photo_tab">
                    <#include "/epc-dev/cloudepc/verifyShop/verifyIndex_photo.ftl">
                    <div class="btn-group">
                        <div class="col-sm-offset-3 col-md-offset-4 col-sm-9 col-md-8 text_left">
                            <a href="/" class="cancel-next">取消认证</a>
...
<!-- build:js ../resources/verify/verify.js -->
<script type="text/javascript" src="/epc-dev/resources/common/plupload/js/plupload.full.min.js"></script>
<script type="text/javascript" src="/epc-dev/resources/common/epc/upload/upload.js"></script>

<script type="text/javascript" src="/epc-dev/resources/common/select2/js/select2.min.js"></script>
<script src="/epc-dev/resources/login/loginNew.js" type="text/javascript"></script>
<script src="/epc-dev/resources/verify/verify.js" type="text/javascript"></script>
<!-- endbuild -->
